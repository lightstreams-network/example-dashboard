...
module.exports = {
  link: [
    ...
    { rel: 'stylesheet', href: '/assets/css/handsontable.full.css' },
    { rel: 'stylesheet', href: '/assets/css/prime/primeng.min.css' },
    { rel: 'stylesheet', href: '/assets/css/prime/omega/theme.css' },
  ],
  meta: [
