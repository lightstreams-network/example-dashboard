...
const userTestData = require('./uphold.test.user');
const cardsTestData = require('./uphold.test.cards');
const transactionTestData = require('./uphold.test.transaction');
...
module.exports = function(config) {
    ...
    return {
        ...
        buildAuthURL: function(scope, state) {
            ...
            return {
                'url': 'http://localhost:3000/api/v1/uphold/token?state='+state,
                'state': state,
                'scope': scope
            };
        },
        ...
        cards: function(callback) {
            callback(null, cardsTestData.cards);
        },
        ...
        createTransaction: function(options, callback) {
            callback(null, transactionTestData.response);
        },
        ...
        user: function(callback) {
            callback(null, userTestData.user);
        },
