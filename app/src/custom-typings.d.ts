...
declare var CLIENT_MODE: string;
declare var LOCAL_SERVER: string;
declare var APP_SERVER: string;
declare var MACHINE_SERVER: string;
declare var PUBLIC_WEB_SERVER: string;
declare var EXPLORER_SERVER: string;
