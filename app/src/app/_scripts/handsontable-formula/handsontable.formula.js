(function (Handsontable) {
   ...
   function HandsontableFormula() {
      ...
      var formulaRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
         ...
         if(instance.onCellRender)
            instance.onCellRender(instance, TD, row, col, prop, value, cellProperties);
      ...
      this.init = function () {
         var instance = this;
         instance.formulasEnabled = false;
         var formulas = instance.getSettings().formulas;
         if(formulas && formulas.enabled)
            instance.formulasEnabled = true

         if (instance.formulasEnabled) {

            if(formulas.onCellRender != undefined)
               instance.onCellRender = formulas.onCellRender
